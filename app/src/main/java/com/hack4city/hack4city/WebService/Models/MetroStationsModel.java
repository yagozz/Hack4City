...
public class MetroStationsModel {
    ...
    public MetroStationsModel(String istasyonId, String adi, String fotograf, String sira, String aktifMi, String koorX, String koorY) {
